      ...
      <div className="container mx-auto px-4 -mt-48 relative z-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {seasons.map((season) => (
                <div key={season.id} className="bg-dark-light p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-400">{season.episode_count} epizoda</p>
                  {season.air_date && (
        ...
        <div className="mt-12">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-3xl font-bold">💬 Recenzije ({reviews.length})</h2>
          ...
          {/* Review Form */}
          {showReviewForm && (
            <form onSubmit={handleSubmitReview} className="bg-dark-light p-6 rounded-lg mb-6">
              <div className="mb-4">
                <label className="block mb-2">Ocjena: {newReview.rating} ⭐</label>
                <input
                  type="range"
                  min="1"
                  max="5"
            ...
            {reviews.map((review) => (
              <div key={review._id} className="bg-dark-light p-6 rounded-lg">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <span className="font-bold text-lg">{review.user.username}</span>
                      ...
                      <div key={idx} className="bg-gray-800 p-3 rounded">
                        <div className="flex justify-between items-start mb-1">
                          ...
                          <span className="text-xs text-gray-500">
                            {new Date(reply.createdAt).toLocaleDateString('hr-HR')}
                          </span>
                        </div>
